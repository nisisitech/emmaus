      ...
      <div class="content-container">
        ...
        <div class="main-page">
          <div class="pagecontente">
            ...
            <div>
              <p>Export All Purchases in store to Excel:</p>
              <form method="post" action="toexcelpurchase.php">
              <input type="submit" name="export_purchases" class="btn btn-success" value="Export" />  
              </form>
              </div>
             <br><br>
             <div class="panel">
