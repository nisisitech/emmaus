                ...
                <div class="main-page">
                    <div class="col-md-8 col-md-offset-2">
                        <div>
                            ...
                            <form action='exportsearchbydate.php' method="POST">
                            <div class="col-md-12">
                                    <div class="col-md-8 col-md-ofset-2">
                                        <label></label>
                                        <input id='user_date' name="date" class="form-control" placeholder="YYYY-MM-DD">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                    <input type="submit" name="exportdailyreport" style="margin: 23px;" class="btn btn-success" value="Export To Excel" />
