      ...
      <div class="content-container">
        ...
        <div class="main-page">
          <div class="pagecontente">
            ...
            <div>
              <form method="post" action="toexcelexp.php">
              <p>Export All Expenses in store to Excel:</p>
              <input type="submit" name="export_expenses" class="btn btn-success" value="Export" />  
              </form>
              </div>
             <br><br>
             <div class="panel">
